...
class EffectBase abstract
 ...
 public:
  ...
  IFACEMETHODIMP GetSource(UINT index,
                          abi::Graphics::Effects::IGraphicsEffectSource** value) override {
 ...
 protected:
  ...
  static HRESULT FindNamedProperty(const NamedProperty* properties, UINT count, LPCWSTR name,
                                   UINT* index, PropertyMapping* mapping) {
