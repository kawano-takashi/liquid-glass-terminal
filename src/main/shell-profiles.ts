...
import type { SettingsV5, ShellProfileDescriptor, ShellProfileKind } from '../shared/contracts';
...
export class ShellProfileRegistry {
  ...
  get(id: string | undefined, settings: SettingsV5): InternalShellProfile | undefined {
