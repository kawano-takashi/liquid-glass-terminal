...
import type { SettingsV4, ShellProfileDescriptor, ShellProfileKind } from '../shared/contracts';
...
export class ShellProfileRegistry {
  ...
  get(id: string | undefined, settings: SettingsV4): InternalShellProfile | undefined {
